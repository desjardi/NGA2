...
contains
   ...
   function construct_from_args(coord,no,x,y,z,xper,yper,zper,name) result(self)
      ...
      self%uniform_x=.false.; if (maxval(self%dx)/minval(self%dx)-1.0_WP.lt.10.0_WP*epsilon(1.0_WP)) self%uniform_x=.true.
      self%uniform_y=.false.; if (maxval(self%dy)/minval(self%dy)-1.0_WP.lt.10.0_WP*epsilon(1.0_WP)) self%uniform_y=.true.
      self%uniform_z=.false.; if (maxval(self%dz)/minval(self%dz)-1.0_WP.lt.10.0_WP*epsilon(1.0_WP)) self%uniform_z=.true.
