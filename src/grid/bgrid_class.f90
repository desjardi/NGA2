...
contains
   ...
   function constructor(n,name) result(self)
      ...
      self%nx=n(1); self%imin=refindex; self%imax=self%imin+self%nx
      self%ny=n(2); self%jmin=refindex; self%jmax=self%jmin+self%ny
      self%nz=n(3); self%kmin=refindex; self%kmax=self%kmin+self%nz
