!> Module that handles the command line interaction of NGA applications.
!> Obtained from https://pastebin.com/Df4UaPU9
module cl_reader
  use string, only: 
  implicit none
  private
  ...
  type clopt
     ...
     character :: sh_name
     !> Description
     character(len=str_long) :: descr
     !> Argument name, if required
     character(len=20) :: argname
   contains
     !> Replace print for this type
